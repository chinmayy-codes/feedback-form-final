      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="max-w-2xl w-full text-center space-y-6">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            This form is intended to assess service quality, communication
            standards, professional conduct, and overall delivery of video
            editing services. The feedback will be used for quality assurance
